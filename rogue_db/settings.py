...
Originally generated by 'django-admin startproject' using Django 5.2.17.
Generated by ./manage.py tom_setup on Aug. 27, 2026, 6:35 p.m.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'rogue_tom_db'),
...
# Facilities listed appear on your TOM's TargetDetail page. INSTALLED_APPS that implement the
# observation_facilities() AppConfig integration point do not need to be listed here.
